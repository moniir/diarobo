        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="col-md-12 col-sm-12">
                    ...
                    <g:form controller="medicine" action="create" method="POST" enctype="multipart/form-data">
                        <fieldset class="form-horizontal">
                        <g:render template="form" model="[medicineAdminList: medicineAdminList, brand: brand, type: 'create']"></g:render>
                        <div class="form-group">
                            <label class="col-md-4 control-label"></label>
                            <div class="col-md-8">
                                <g:actionSubmit value="SAVE" action="create" class="btn btn-primary"></g:actionSubmit>
                            </div>
                        </div>
                        </fieldset>
                    </g:form>
