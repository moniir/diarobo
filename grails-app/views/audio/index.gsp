...
<ol class="breadcrumb">
    ...
    <li><a href="${createLink(controller: 'audio', action: 'index')}">Audio</a></li>
    ...
    <div class="col-lg-12">
        <div class="panel panel-info" >
            <div class="panel-heading">
                <div class="panel-title panel-title-list ">Notification Audio Details
                    <span class="pull-right"><a href="${createLink(controller: 'audio', action: 'create')}"><i class="fa fa-plus" aria-hidden="true"></i></a></span>
                </div>
            </div>
...
<script>
    $('#list-table').dataTable({
        ...
        "iDisplayLength": 10,
        "aaSorting": [0, 'asc'],
        "sAjaxSource": "${g.createLink(controller:'audio', action:'list')}",
    ...
    $('#list-table').on('click', 'a.delete-reference', function (e) {
        ...
        if (confirmDel == true) {
            ...
            jQuery.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: "${g.createLink(controller: 'audio',action: 'delete')}?id=" + referenceId,
    ...
    $('#list-table').on('click', 'a.edit-reference', function (e) {
        ...
        var control = this;
        var referenceId = $(control).attr('referenceId');
        window.location.href="${g.createLink(controller: 'audio',action: 'edit')}?id=" + referenceId;
        e.preventDefault();
    });
